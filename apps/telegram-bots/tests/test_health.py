...
async def test_health_returns_ok() -> None:
    ...
    assert body["service"] == "campus-telegram-bots"
...
async def test_bot_list_includes_all_phase1() -> None:
    ...
    for required in [
        "student", "parent", "teacher", "hr", "library",
        "cafeteria", "transport", "helpdesk", "edms", "rector",
    ]:
...
async def test_webhook_rejects_bad_secret() -> None:
    ...
    # Should be 401 (bad secret) or 503 (no token configured for student bot in tests)
