...
**Modular monolith** yondashuvi: bitta Laravel ilova, lekin har modul **alohida papka** (`Modules/HR/`, `Modules/Students/`, va h.k.) — `nwidart/laravel-modules` paketi orqali.
